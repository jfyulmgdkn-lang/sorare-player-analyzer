...
def get_club_starter_stats_2026_27(
    ...
    while True:
        ...
        # Sobald wir komplett vor Saisonstart sind, können wir aufhören.
        if page_dates and max(page_dates) < season_start:
            break
...
def get_club_matchday_scores_2026_27(
    ...
    while True:
        ...
        for game in connection.get("nodes") or []:
            ...
            # Nur Saison 2026/27 und nur bereits gespielte Partien.
            if game_date < season_start:
                continue
        ...
        # pastGames ist chronologisch rückwärts. Sobald eine komplette
        # Seite nur noch vor Saisonstart liegt, brauchen wir nicht weiter.
        if page_dates and max(page_dates) < season_start:
            break
...
async def on_ready():
    ...
    print("Version: Contender + Kartenpositionen + Ligue-2-5er-Filter")
